...
const categories: FeatureCategory[] = [
{
  ...
  rows: [
  {
    feature: 'Number of fanflets',
    free: '5',
    pro: 'Unlimited',
    enterprise: 'Unlimited'
  },
  {
    feature: 'Personalized branded URLs',
    free: true,
    pro: true,
    enterprise: true
  },
  {
    feature: 'Profile and bio with photo',
    free: true,
    pro: true,
    enterprise: true
  },
  {
    feature: 'Custom resources and links',
    free: true,
    pro: true,
    enterprise: true
  },
...
},
{
  ...
  rows: [
  {
    feature: 'Surveys and session feedback',
    free: false,
    pro: true,
    enterprise: true
  },
  {
    feature: 'Opt-in email list building',
    free: false,
    pro: true,
    enterprise: true
  },
  {
    feature: 'Fanflet expiration',
    free: '14 days',
    pro: '30, 60, 90 days',
    enterprise: 'Custom'
  }]
...
},
{
  ...
  rows: [
  {
    feature: 'Basic engagement stats',
    free: true,
    pro: true,
    enterprise: true
  },
  {
    feature: 'Click-through analytics',
    free: false,
    pro: true,
    enterprise: true
  },
...
},
{
  ...
  {
    feature: 'SSO and team management',
    free: false,
    pro: false,
    enterprise: true
  },
    ...
    <section
      ...
      <div className="max-w-5xl mx-auto">
              ...
              <tr
                ...
                <th className="text-center py-4 px-4 w-1/5">
                  <div className="flex items-center justify-center gap-1.5">
                    <AccentDot color="var(--color-emerald)" />
                    <span
                ...
                <th className="text-center py-4 px-4 w-1/5">
                  <div className="flex items-center justify-center gap-1.5">
                    <AccentDot color="var(--color-violet)" />
                    <span
                      className="text-sm font-semibold"
                      style={{
                        color: 'var(--color-navy)'
        ...
        <div className="md:hidden space-y-6">
          {(['Free', 'Pro', 'Enterprise'] as const).map((tier, tierIdx) => {
            ...
            const headerStyle: React.CSSProperties = isFree ?
            {
              ...
              color: 'white',
              borderBottom: '1px solid var(--color-emerald)'
            } :
            isHighlighted ?
            {
            ...
            {
              background:
              'linear-gradient(135deg, var(--color-violet), var(--color-navy))',
              color: 'white',
