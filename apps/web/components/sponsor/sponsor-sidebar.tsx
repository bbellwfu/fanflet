...
import { Menu, LayoutDashboard, Users, Link2, Plug, Settings, LogOut, Clock, Library, Megaphone, BarChart3, CreditCard, ScrollText } from "lucide-react";
...
const sponsorNavItems = [
  ...
  { icon: CreditCard, label: "Billing", href: "/sponsor/billing" },
  { icon: ScrollText, label: "Activity Log", href: "/sponsor/audit-log" },
